...
no console.
*/
//console.log(`Nome da serie: ${serie.nome}. Quantidade de temporadas: ${serie.temporadas}. Quantidade de episodios: ${serie.episodios}. Emissora: ${serie.emissora}.`);
...
*/
serie.nome = 'One Peace';
serie.temporadas = 20;
serie.episodios = 1000;
serie.emissora = 'crunchyroll';
